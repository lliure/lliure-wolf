...
<div class="painelCtrl">
	<div class="bloco">
		...
		if(ll_tsecuryt()) {
			...
			<div class="listp">
				<div class="inter link_idioma">
                    <a href="<?php echo $_ll['app']['sen_html']. '&p=idiomas';?>"><img src="imagens/layout/language.png" alt="" /></a>
					<a href="<?php echo $_ll['app']['sen_html']. '&p=idiomas';?>"><span>Idiomas</span></a>
				</div>
			</div>
		...
		<div class="listp">
			<div class="inter">
				<a href="<?php echo $_ll['app']['sen_html']. '&p=sobre';?>" class="llSobre"><img src="imagens/layout/info.png" alt="" /></a>
				<a href="<?php echo $_ll['app']['sen_html']. '&p=sobre';?>" class="llSobre"><span>Sobre</span></a>
			</div>
		</div>	
		...
		if($erroAbrirDir == false) {
			...
			foreach($appFolder as $chave => $file)
				if(ll_tsecuryt()) {
					...
					<div class="listp">
						<div class="inter">
							<a href="<?php echo $_ll['app']['sen_html']. '&p=install&app='. $file ;?>" class="install"><img src="opt/instalilo/ico.png" alt="<?php echo $app_nome?>" /></a>
							<a href="<?php echo $_ll['app']['sen_html']. '&p=install&app='. $file ;?>" class="install"><span><?php echo $app_nome; ?></span></a>
						</div>
					</div>
					<?php
				}
