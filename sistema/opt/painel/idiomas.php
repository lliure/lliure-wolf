...
case 'home':
		...
		$pg_idiomas .= '<table class="table">'
			...
			foreach($arrayConf['idiomas'] as $chave => $valor){
				$pg_idiomas .= '<tr>'
									...
									.'<td><a href="'.$_ll['app']['sen_html'].'&p=idiomas&ac=natv&amp;idi='.$valor.'" class="jfbox"><img src="imagens/icones/'.($chave == 'nativo' ? 'round_checkmark' : 'round').'.png"></a></td>'
									
									.'<td><a href="'.$_ll['app']['sen_html'].'&p=idiomas&ac=del&amp;idi='.$valor.'" class="jfbox"><img src="imagens/icones/trash.png"></a></td>'
							  .'</tr>';
	...
	$pg_idiomas .=
		 '<form class="form jfbox" action="'.$_ll['app']['sen_html'].'&p=idiomas&ac=write">'
			.'<fieldset>'
				.'<div>'
...
case 'del':
	...
	header('location: '.$_ll['app']['sen_html']. '&p=idiomas');
break;
